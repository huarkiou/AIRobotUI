...
- 124 个单元测试：cli (20)、config_ui (25)、process_mgr (22)、http_server (23)、main_window (11)、startup (10)、headless (4)、config (4)、logger (5)
- 7 个集成测试
- 全部测试：`uv run pytest tests/ -v`（131 tests）
